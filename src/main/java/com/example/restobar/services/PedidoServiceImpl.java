...
public class PedidoServiceImpl extends BaseServiceImple<Pedido, Long> implements PedidoService{
    ...
    private PedidoRepository pedidoRepository;
      ...
      @Override
      @Transactional
      public Pedido crearPedidoConItem(Pedido pedido, Mesa mesa, Item items) throws Exception {
          try {
              // Crear el item con el producto

              Item item = itemService.crearItemConProducto(items);
              ...
              // Guardar el pedido en la base de dato
              pedido.setMesa(mesa);
